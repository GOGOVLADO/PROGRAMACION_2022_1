Algoritmo par_impar_complemento								//Inicio algoritmo
	...
	Escribir "Ingrese un numero entero"							//Solicitar acción del usuario
	Leer num													//Leer variable ingresada
	si num%2=0  Entonces										//Condición para determinar si el valor registrado es par
		Escribir num " es un numero par." 						//Si la condición es verdadera,si imprime este mensaje
		Escribir "Los numeros pares desde 0 hasta " num "son:"	//Si la condición es verdadera,si imprime este mensaje
	...
	SiNo														//Salta de condición
		Escribir num " es un numero impar."						//Si la condición es falsa se imprime este mensaje
